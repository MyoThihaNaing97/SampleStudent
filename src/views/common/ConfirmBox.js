            ...
            <CModal centered closeOnBackdrop={false} show={props.show} style={{boxShadow: 'rgb(0 0 0 / 25%) 0px 3px 7px'}}>
                <CModalBody className="m-body">
                    ...
                    <CButtonToolbar className="confirm-body" justify="center">
                        <CButton className="ok-confirm-btn" style={{backgroundColor:'green',color:'white'}} onClick={
                    ...
                    <CButton className="cancel-confirm-btn" style={{marginLeft: "60px",backgroundColor:'red'}} onClick={props.cancel}>{props.cancelButton}</CButton>
                    </CButtonToolbar>
                </CModalBody>
            </CModal>
        </>
